...
# Load your dataset
emails = pd.read_csv('updated_balanced_datasetV2.csv', encoding='ISO-8859-1').drop_duplicates()  # noqa
print('read dataset')
...
joblib.dump(svm_classifier, 'out/svm_model.joblib')
joblib.dump(tfidf_vectorizer, 'out/tfidf_vectorizer.joblib')
